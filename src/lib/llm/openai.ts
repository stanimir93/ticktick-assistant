...
export const openaiProvider = createOpenAICompatibleProvider(
  ...
  {
    default: 'gpt-5.2',
    options: ['gpt-5.2', 'gpt-5.1', 'gpt-5', 'gpt-5-mini', 'gpt-5-nano', 'o4-mini', 'o3'],
  }
);
...
export const grokProvider = createOpenAICompatibleProvider(
  ...
  '/api/llm/grok',
  {
    ...
    options: ['grok-4-1-fast-non-reasoning', 'grok-4-1-fast-reasoning', 'grok-4-fast-non-reasoning', 'grok-4-fast-reasoning', 'grok-3', 'grok-3-mini'],
  }
);
